...
def seed_watchlists():
    watchlist1 = Watchlist(list_name='My watchlist', user_id=1)
    watchlist2 = Watchlist(list_name='Watchlist', user_id=2)
    watchlist3 = Watchlist(list_name='My Watchlist', user_id=3)
